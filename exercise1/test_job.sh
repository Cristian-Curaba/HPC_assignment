...
for j in {1..2}
do	
	echo -e "$j, 100x100, , , , , ,node, , , , , , cores close" >> ../statistics/STATISTICS.csv	
	mpirun -np 4 --map-by socket ../a.out -r -x 1000 -y 1000 -e 1 -n 100 -s 25 -f small_exp_100x100.pgm >> ../statistics/STATISTICS.csv
